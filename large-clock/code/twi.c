...
****************************************************************************/
/*
 *		This file has been converted from IAR C compiler to AVRGCC by
 *		Bart Bilos from the Netherlands.
 *		See AVR315 application note for more information.
 *		Changed for the ATmega 4/8/16 8.
 */
